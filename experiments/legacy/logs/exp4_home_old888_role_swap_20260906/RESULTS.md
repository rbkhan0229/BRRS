...
User requested logical-role swap only after prior home placement change. Existing physical INIT933 becomes TX N3; physical N3/888 becomes INIT. N2/584 and N4/818 stay unchanged. No physical moves, power cycles, port or cable changes by agent.
...
| 역할 | 실제 serial | SHA256 |
|---|---|---|
| init | 1050273888 | `0a020d4cef54c3ac81c248fdf4595c589e500073699750650ca44a59a0d2b737` |
| N2 | 1050211584 | `9b84be4f94f75257b64b52ac248195d54e669315dc3f8cae054e99a41606ab20` |
| N3 | 1050270933 | `9a1fa14ef6fcfd81619c33c5720aec2603b6c8ceb3c1403717f4e7d6ed58f651` |
...
| N4 | 1000 | 989 | 11 | 1.100% |
| 전체 | 3000 | 2989 | 11 | 0.367% |

INIT 수집 시각(KST): 2026-09-06T23:30:07.649547+09:00 – 2026-09-06T23:30:22.090118+09:00. 이는 수집 구간이며 개별 RF 프레임의 wall-clock 시각 계측값은 아니다.
...
N3 PER=0.000%. 사전 고손실 재현 기준 N3≥10%는 미충족. 각 노드 PER<1% 목표는 실패. 집 배치를 NLOS 6.9m와 동일 채널로 보지 않으며, 미재현을 기존 문제 해결로 해석하지 않는다.
...
노드별 목표를 넘는 손실 표본이 있으므로 A/B를 구현·비교할 실험적 가치는 있다. 먼저 이 세팅을 고정하고 baseline 손실의 반복 안정성을 확인하면 비교 해석이 좋아진다. A/B에서는 RX 방식만 바꾸고 M32/PAC8·전원·역할·위치·출력·TDMA·비수신 절전·재전송 없음 조건을 고정해야 한다. 이번에는 요청된 1회에서 종료했고 코드 구현/추가 실행은 하지 않았다.
