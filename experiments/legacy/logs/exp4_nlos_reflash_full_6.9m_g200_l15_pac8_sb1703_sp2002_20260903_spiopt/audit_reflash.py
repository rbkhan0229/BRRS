#!/usr/bin/env python3
"""Read-only audit of one original-position same-image reflash/restart repeat. Same SB1703/SP2002 full-configure binaries; PER failure remains failure."""
import csv
import hashlib
...
def audit(mode, run):
    ...
    try:
        for role, serial in SERIALS.items():
            ...
            assert meta["environment"] == "nlos_reflash_full"
...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 3:
        ...
        raise SystemExit("usage: audit_reflash.py [1703 1]")
