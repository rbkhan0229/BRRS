...
#if defined(TEST_INIT_AGGREGATED_ACKS_2NODES)

extern void test_run_info(unsigned char *data);

/* Example application name */
#define APP_NAME "INITIATOR NODE v1.0 (2-NODE TEST: INIT+N5)"
            ...
            if (last_sync_cycles == 0 || dwt_timer_elapsed(last_sync_cycles, period_interval_cycles)) {
                ...
                if (current_cycle > 1000 && !final_stats_printed) {
                    ...
                    snprintf(final_stats, sizeof(final_stats),
                            ...
                            "Pair 1 (Period 1-2): DATA: Success=%d, Fail=%d, IDLE=%d\n"
                            "Pair 2 (Period 3-4): DATA: Success=%d, Fail=%d, IDLE=%d\n"
                            "Pair 3 (Period 5-6): DATA: Success=%d, Fail=%d, IDLE=%d\n\n"
                            "=== CYCLE STATISTICS ===\n"
                            "Total Cycles: %d\n"
