...
def main():
    ...
    p.add_argument('--profile',choices=['preparation','full','standard','essential','lite','paper'],default='essential');p.add_argument('--confirmation',action='store_true');p.add_argument('--capacity-candidates',action='store_true')
