...
prior = json.loads((R.parent / 'vehicle_dashboard_beacon512_pac8_l26_once_20260908/RESULTS.json').read_text())
...
lines = ['# 차량 대시보드 RX · 비컨 M512 · N2 뒤집은 뒤 1회', '',
...
lines += ['', '정확히 1회 RF 실행. 종료 후 7대 플래시 readback PASS 및 정지를 확인했다. 로컬·원격 잔여 캡처 프로세스 0, 기존 Git 브랜치·HEAD·dirty 상태 변경 없음. commit/push 없음. 설치 방향 변경 1회 관측으로 단일 원인을 확정하지 않는다.', '',
