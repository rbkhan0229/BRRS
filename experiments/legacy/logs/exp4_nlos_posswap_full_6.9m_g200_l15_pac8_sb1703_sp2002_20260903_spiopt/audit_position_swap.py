#!/usr/bin/env python3
"""Read-only audit of one N2/N3 physical-position swap. Same SB1703/SP2002 full-configure binaries; PER failure remains failure."""
import csv
import hashlib
...
def audit(mode, run):
    ...
    try:
        for role, serial in SERIALS.items():
            ...
            assert meta["environment"] == "nlos_posswap_full"
...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 3:
        ...
        raise SystemExit("usage: audit_position_swap.py [1703 1]")
