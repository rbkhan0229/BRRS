...
User reports TX nodes remain in dryer and RX/INIT has now been hidden behind a refrigerator. Exactly one further run requested. Original serial roles retained; no agent physical/cable/power/port/appliance-control changes. Appliance door/operation states unmeasured.
...
| N3 | 1000 | 953 | 47 | 4.700% |
| N4 | 1000 | 999 | 1 | 0.100% |
| 전체 | 3000 | 2952 | 48 | 1.600% |

INIT 수집 시각(KST): 2026-09-06T23:44:14.275711+09:00 – 2026-09-06T23:44:27.992069+09:00. 이는 수집 구간이며 개별 RF 프레임의 wall-clock 시각 계측값은 아니다.
...
N3 PER=4.700%. 사전 고손실 재현 기준 N3≥10%는 미충족. 각 노드 PER<1% 목표는 실패. 집 배치를 NLOS 6.9m와 동일 채널로 보지 않으며, 미재현을 기존 문제 해결로 해석하지 않는다.
