...
User placed TX nodes in a dryer, then requested restoration of original roles and exactly one run. Agent preserves this new placement and does not change cables, USB ports, power configuration or appliance controls. Door state and appliance operation not independently verified.
...
| N3 | 1000 | 945 | 55 | 5.500% |
| N4 | 1000 | 980 | 20 | 2.000% |
| 전체 | 3000 | 2925 | 75 | 2.500% |

INIT 수집 시각(KST): 2026-09-06T23:38:19.809947+09:00 – 2026-09-06T23:38:33.228206+09:00. 이는 수집 구간이며 개별 RF 프레임의 wall-clock 시각 계측값은 아니다.
...
N3 PER=5.500%. 사전 고손실 재현 기준 N3≥10%는 미충족. 각 노드 PER<1% 목표는 실패. 집 배치를 NLOS 6.9m와 동일 채널로 보지 않으며, 미재현을 기존 문제 해결로 해석하지 않는다.
